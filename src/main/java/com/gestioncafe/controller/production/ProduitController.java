...
public class ProduitController {
    ...
    public ProduitController(ProduitService produitService,
                             ...
                             PackageProduitService packageProduitService,
    ...
    public String ficheTechnique(@PathVariable Integer id, Model model) {
        ...
        if (recettes == null || recettes.isEmpty()) {
            ...
            List<Map<String, Object>> detailsFiche = new java.util.ArrayList<>();
            for (DetailRecette detail : details) {
                ...
                if (estimationRecente != null && estimationRecente.getPrix() != null) {
                    BigDecimal prixEstime = BigDecimal.valueOf(estimationRecente.getPrix());
                    BigDecimal valeurParNormeEstimation = estimationRecente.getUnite() != null &&
                        estimationRecente.getUnite().getValeurParNorme() != null ? estimationRecente.getUnite().getValeurParNorme() : BigDecimal.ONE;
        ...
        model.addAttribute("prixVente", prixVente != null ? prixVente.getPrixVente() : BigDecimal.ZERO);
