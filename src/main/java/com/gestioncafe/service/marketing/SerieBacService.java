...
public class SerieBacService {
    ...
    private final SerieBacRepository serieBacRepository;

    public SerieBacService(SerieBacRepository serieBacRepository) {
        this.serieBacRepository = serieBacRepository;
    }
