...
VALUES (1, 2000, '2024-01-01') ,
    ...
    ,
    (1, 2100, '2024-06-01')
    , -- test: nouveau prix pour Café Noir
    (2, 2600, '2024-06-01');
...
VALUES (1, 1, 2, 2000, 4000) , -- 2 Café Noir
    ...
    ,
    (13, 1, 1, 2100, 2100)
    , -- test: vente Café Noir avec nouveau prix
    (13, 2, 2, 2600, 5200)
...
VALUES ('Café vert', 2, 3, 100, '/images/mp-cafe-vert.jpg') , -- kg
    ('Sucre', 2, 3, 50, '/images/mp-sucre.jpg')
    , -- kg
    ('Lait', 3, 4, 30, '/images/mp-lait.jpg')
    , -- L
    ('Chocolat', 4, 2, 40, '/images/mp-chocolat.jpg')
    , -- sachet
    ('Thé vert', 4, 2, 25, '/images/mp-the-vert.jpg')
    , -- sachet
    ('Crème', 3, 4, 15, '/images/mp-creme.jpg')
    , -- L
    ('Miel', 3, 4, 10, '/images/mp-miel.jpg')
    , -- L
    ('Cannelle', 5, 1, 8, '/images/mp-cannelle.jpg')
    , -- boîte
...
VALUES (1, 12000, 50, 2, '2024-06-01') , -- Café vert, 50kg à 12000, unité kg
    (1, 12500, 60, 2, '2024-06-15')
    , -- Café vert, 60kg à 12500, unité kg
    (2, 4000, 25, 2, '2024-06-05')
    , -- Sucre, 25kg à 4000, unité kg
    (2, 4200, 30, 2, '2024-06-20')
    , -- Sucre, 30kg à 4200, unité kg
    (3, 9000, 20, 3, '2024-06-08')
    , -- Lait, 20L à 9000, unité L
    (3, 9500, 25, 3, '2024-06-22')
    , -- Lait, 25L à 9500, unité L
    (4, 2500, 10, 4, '2024-06-09')
    , -- Chocolat, 10 sachets à 2500, unité sachet
    (5, 1800, 15, 4, '2024-06-11')
    , -- Thé vert, 15 sachets à 1800, unité sachet
    (6, 3500, 10, 3, '2024-06-13')
    , -- Crème, 10L à 3500, unité L
    (7, 4000, 5, 3, '2024-06-14')
    , -- Miel, 5L à 4000, unité L
    (8, 1200, 2, 5, '2024-06-17')
    , -- Cannelle, 2 boîtes à 1200, unité boîte
