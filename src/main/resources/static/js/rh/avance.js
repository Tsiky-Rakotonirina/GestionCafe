// Script pour rendre la table des avances triable
document.addEventListener('DOMContentLoaded', function() {
    ...
    headers.forEach((header, index) => {
        // Rendre les colonnes Date avance et Montant triables (indices 0 et 1)
        if (index === 0 || index === 1) {
            header.classList.add('sortable');
            
            // Créer le conteneur pour le header avec icône
            const headerText = header.innerHTML;
            const sortIcon = 'fas fa-sort-numeric-up';
